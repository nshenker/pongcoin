...
export class PongComponent extends React.Component<PongProps, PongState> {
  ...
  windowWidth: number = window.innerWidth*0.80;
  windowHeight: number = window.innerHeight*0.7;
  ...
  yPaddleLeft: number = this.windowHeight / 2.8;
  xPaddleRight: number = this.windowWidth - this.borderOffset - this.paddleWidth;
  yPaddleRight: number = this.windowHeight / 2.8;
